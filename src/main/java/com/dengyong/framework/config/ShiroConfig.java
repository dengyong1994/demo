package com.dengyong.framework.config;
...
import com.dengyong.framework.shiro.realm.UserRealm;
import com.dengyong.framework.shiro.session.OnlineSessionDAO;
import com.dengyong.framework.shiro.session.OnlineSessionFactory;
import com.dengyong.framework.shiro.web.filter.LogoutFilter;
import com.dengyong.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
...
public class ShiroConfig
{
   ...
   /* *//**
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/dengyong.png**", "anon");
        ...
        filterChainDefinitionMap.put("/dy/**", "anon");
