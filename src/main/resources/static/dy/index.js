...
function SmoothlyMenu() {
	if (!$('body').hasClass('mini-navbar')) {
    	$('#navbar-minimalize').attr('title','收起菜单')
    	$('.navbar-minimalize i').addClass("fa-backward");
    	$('.navbar-minimalize i').removeClass("fa-forward");
        $('#side-menu').hide();
    	...
    	$('.navbar-minimalize').attr('title','展开菜单');
    	$('.navbar-minimalize i').removeClass("fa-backward");
    	$('.navbar-minimalize i').addClass("fa-forward");
        $('#side-menu').hide();
        $(".sidebar-collapse .logo").addClass("hide");
        setTimeout(function() {
            $('#side-menu').fadeIn(500);
